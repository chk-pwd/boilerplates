...
resource "proxmox_vm_qemu" "k3s-master-2" {
  ...
  ipconfig0 = "ip=172.16.16.5${count.index + 1}/24,gw=172.16.16.1"
...
resource "proxmox_vm_qemu" "k3s-agent-2" {
  ...
  ipconfig0 = "ip=172.16.16.6${count.index + 1}/24,gw=172.16.16.1"
